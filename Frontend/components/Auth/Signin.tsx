...
const Signin = () => {
  ...
  const loginUser = async (event: any) => {
    ...
    try {
      ...
      const response = await fetch("http://localhost:999/bajansociety/user/login", {
        method: "POST",
        headers: {
            ...
            <form onSubmit={loginUser}>
              ...
              <div className="flex flex-wrap items-center gap-10 md:justify-between xl:gap-15">
                ...
                <button type="submit"
                  ...
                  className="inline-flex items-center gap-2.5 rounded-full bg-black px-6 py-3 font-medium text-white duration-300 ease-in-out hover:bg-black dark:bg-btndark dark:hover:bg-black"
                >
                  Log in
                  <svg
